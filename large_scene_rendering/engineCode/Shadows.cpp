...
void computeShadowDepthMap(glm::mat4 lightView, glm::mat4 lightProjection, vector<Model*> toDrawShadows, UserCamera &mainCam){
  ...
  for (size_t i = 0; i < toDrawShadows.size(); i++){
    ...
    drawGeometryShadow(depthShader.ID, *toDrawShadows[i], materials[0], I, mainCam);
  }
